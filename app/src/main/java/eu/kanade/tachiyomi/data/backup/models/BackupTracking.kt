...
/**
 * Legacy 3rd-party tracking payload retained only so backups written by older builds (and other
 * forks) still deserialize. This fork uses an in-app local tracker and neither writes nor restores
 * this data.
 */
@Serializable
