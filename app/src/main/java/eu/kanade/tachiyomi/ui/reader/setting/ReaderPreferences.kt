...
class ReaderPreferences(
    ...
    val enableDoubleTapZoomPager: Preference<Boolean> = preferenceStore.getBoolean(
    ...
    val webtoonSmoothScroll: Preference<Boolean> = preferenceStore.getBoolean("webtoon_smooth_scroll", false)
